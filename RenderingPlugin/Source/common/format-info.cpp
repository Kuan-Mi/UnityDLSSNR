// Format info table ported from NVRHI (External/nvrhi/src/common/format-info.cpp).
// Copyright (c) 2021, NVIDIA CORPORATION. MIT license (see ThirdParty/NVRHI-LICENSE.txt).

#include "format-info.h"
...
//        format                   name             bytes blk         kind               red   green   blue  alpha  depth  stencl signed  srgb
    ...
    { Format::A8_UNORM,          "A8_UNORM",           1,   1, FormatKind::Normalized,   false, false, false, true,  false, false, false, false },
};
